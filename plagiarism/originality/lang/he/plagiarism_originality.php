...
$string['originality_waitingprocessmsg'] = "בתהליך שליחה";

$string['originality_info'] = "מידע על מקוריות";

$string['originality_server'] = "שרת מקוריות";

$string['originality_settings'] = "מאפיינים של מקוריות";

$string['originality_upgrade'] = "עדכון מקוריות";

$string['originality_no_upgrade'] = "גרסה עדכנית של הפלאגין ";
...
$string['originality_live_server'] = "לייב";

$string['originality_test_server'] = "טסט";

$string['originality_customerservice_email'] = "customerservice@originality.co.il";

$string['originality_upgrade_error']= "תקלה בשדרוג.";

$string['originality_server_production'] = "<b>שרת מקוריות</b>&nbsp;&nbsp;<span style='font-size:14px;'>לשלוח את העבודות לשרת היצור של מקוריות.</span>";

$string['originality_server_test'] = "<b>שרת ניסוי</b>&nbsp;&nbsp;<span style='font-size:14px;'>לשלוח את העבודות לשרת הניסוי (טסט) של מקוריות. יש לבחור זאת רק לאחר תיאום עם מקוריות.</span>";